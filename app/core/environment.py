...
# Boyutlar 2026-09-14 ofis PC'sinde yapılan gerçek kurulumdan ölçüldü (bkz. CLAUDE.md "Mevcut durum"):
# packages = indirilen paket dosyalarının toplamı (torch dahil, kurulum sonrası silinir);
# models = %LOCALAPPDATA%\datalab\datalab\Cache\models klasörünün gerçek boyutu.
SETUP_STEPS = [

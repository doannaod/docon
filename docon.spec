...
açılışta bunları kendi ortamına (%LOCALAPPDATA%\\DonusumProgrami\\runtime) kurar
...
Not: uygulama adı (görünen) "Docon" — app/__init__.py APP_NAME. İç veri klasörü
(%LOCALAPPDATA%\\DonusumProgrami) hâlâ eski adla; mevcut kurulumların indirdiği
modeller/geçmiş kaybolmasın diye bilinçli olarak değiştirilmedi.
"""
